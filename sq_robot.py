...
class Robot(object):
    def __init__(self):
        self.brain = Brain()
        self.brain.sentences_mem = open('./study_data/sentences_mem.txt','r',encoding='utf-8').read().split('\n')
    ...
    def study_vocab(self):
        while True:
            ...
            if word == 'quit':
                ...
                with open('./study_data/words_mem.txt','a',encoding='utf-8') as f:
                    f.write(word+'\n')
    def study_sentence(self):
        while True:
            ...
            if sentence == 'quit':
                ...
                # 将学到的词语存储到机器人的神经元中
                with open('./study_data/sentences_mem.txt','a',encoding='utf-8') as f:
                    f.write(sentence+'\n')
